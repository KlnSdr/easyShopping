const baseListProducts: ProductObj[] = [
    ...
    { n: 'Batate', s: 'selectObstGemuse', sl: false, c: 1 },
    ...
    { n: 'Antipasti', s: 'selectObstGemuse', sl: false, c: 1 },
    ...
    { n: 'Kokoscème', s: 'selectGenuss', sl: false, c: 1 },
    ...
    { n: 'Kräuterlinge', s: 'selectObstGemuse', sl: false, c: 1 },
    ...
    { n: 'Veganer Bratwurst', s: 'selectTiefgefroren', sl: false, c: 1 },
