...
APPLICATION_JSON="src/com/klnsdr/easyShopping/application/resource/application.json"
INFO_COMPONENT="src/com/klnsdr/easyShopping/application/public/mainScreen/components/InfoScreen/InfoScreen.ts"
FRONTEND_LOCATION="src/com/klnsdr/easyShopping/application"
IMAGE_NAME="easyshopping"
...
sed -i -E "s/(text: 'v)[0-9]+\.[0-9]+(')/\1$NEW_VERSION\2/" $INFO_COMPONENT
